  ...
  void _handleLogin() async {
    ...
    if (phone.isEmpty || password.isEmpty) {
       ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text(TTexts.errEmptyFields), backgroundColor: Colors.red),
      );
      return;
    }
    ...
    // Simulate email from phone for Firebase Auth
    final email = '$phone@myfschools.com';

    final error = await _authController.loginWithEmailPassword(email, password);
