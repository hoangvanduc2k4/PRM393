class TTexts {
  ...
  // -- Buttons & Actions
  static const String tRememberMe = "Ghi nhớ đăng nhập?";
  static const String tForgetPassword = "Quên mật khẩu?";
  static const String signIn = "Đăng nhập";

  // -- Auth Error Messages
  static const String errUserNotFound = "Tài khoản không tồn tại.";
  static const String errWrongPassword = "Sai mật khẩu.";
  static const String errInvalidCredential = "Thông tin đăng nhập không hợp lệ.";
  static const String errWeakPassword = "Mật khẩu quá yếu (ít nhất 6 ký tự).";
  static const String errEmailInUse = "Số điện thoại này đã được đăng ký.";
  static const String errDefaultAuth = "Đã xảy ra lỗi. Vui lòng thử lại.";
  static const String errSystem = "Đã xảy ra lỗi hệ thống: ";
  static const String errEmptyFields = "Vui lòng nhập đầy đủ thông tin";

  static const String copyRight = "© 2026 MyFSchools phiên bản 1.0";
  ...
  static const String validationEnterPhone = "Vui lòng nhập số điện thoại";
  static const String validationRequired = "Bắt buộc";
  static const String confirmPassword = "Xác nhận mật khẩu";
  static const String resendOtp = "Gửi lại OTP";
  static const String resendOtpIn = "Gửi lại OTP sau";
  ...
  // -- Home Screen
  static const String greeting = "Chào buổi tối";
  static const String utilities = "Tiện ích";
  ...
  // -- Form Types
  static const String typeSickLeave = "Xin nghỉ ốm";
  static const String typeLateArrival = "Xin đến muộn";
  static const String typeAbsentExtracurricular = "Xin vắng mặt ngoại khóa";
  static const String typeRegisterMeals = "Xin đăng ký ăn bán trú";
  static const String typeRegisterBus = "Xin đăng ký xe tuyến";
  static const String typeChangeClass = "Xin chuyển lớp";
